...
class PatientSummaryRequest(BaseModel):
    ...
    patient_id: str
    document_texts: List[str] = Field(..., description="List of document texts to summarize")
    include_recommendations: bool = Field(False, description="Include AI recommendations")
...
class TerminologyRequest(BaseModel):
    ...
    terms: List[str] = Field(..., description="Medical terms or abbreviations to expand")
