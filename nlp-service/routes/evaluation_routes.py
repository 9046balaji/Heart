...
class EvaluationRequest(BaseModel):
    ...
    contexts: Optional[List[List[str]]] = Field(None, description="Optional list of contexts for each question")
...
class ContinuousEvaluationRequest(BaseModel):
    ...
    interval_minutes: int = Field(default=60, ge=1, le=1440, description="Interval between evaluations in minutes")
