    ...
    def get_parallel_groups(self) -> List[List[AgentTask]]:
        ...
        while remaining:
            ...
            ready = [
                ...
                if all(d in executed for d in t.dependencies)
            ]
...
- Always end with validator for medical accuracy'''
    ...
    EMERGENCY_KEYWORDS = [
        ...
        "chest pain severe", "crushing chest pain", "chest tightness",
    ...
    def _create_rule_based_plan(
        ...
        def add_task(agent: AgentType, desc: str, deps: List[str] = None, priority: int = 3):
            nonlocal task_id
            task_id += 1
            tasks.append(AgentTask(
        ...
        symptom_keywords = ["pain", "ache", "hurt", "symptom", "feeling", "dizzy", "nausea"]
        ...
        # Medication queries
        med_keywords = ["medication", "medicine", "drug", "pill", "dose", "taking", "prescription"]
        ...
        cardio_keywords = ["heart", "cardio", "blood pressure", "bp", "pulse", "ecg", "cholesterol"]
        ...
        lifestyle_keywords = ["diet", "exercise", "sleep", "stress", "weight", "lifestyle"]
