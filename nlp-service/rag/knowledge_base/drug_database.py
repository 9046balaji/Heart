    ...
    def _load_drugs(self) -> None:
        ...
        drugs = [
            ...
            Drug(
                ...
                indications=["Hypertension", "Heart failure", "Post-heart attack", "Diabetic nephropathy"],
                ...
                serious_side_effects=["Angioedema (facial swelling)", "Hyperkalemia", "Acute kidney injury"],
                contraindications=["Pregnancy", "History of angioedema with ACE inhibitors", "Bilateral renal artery stenosis"],
                monitoring=["Blood pressure", "Kidney function (creatinine)", "Potassium levels"],
                food_interactions=["Potassium supplements", "Salt substitutes with potassium"],
                warnings=["May cause dry cough in 5-20% of patients", "Stop immediately if facial/throat swelling occurs"],
            ),
            Drug(
                id="enalapril",
                ...
                contraindications=["Pregnancy", "Angioedema history", "Use with sacubitril"],
            ...
            Drug(
                ...
                indications=["Hypertension", "Diabetic nephropathy", "Stroke prevention in hypertension with LVH"],
                dosing="Initial: 50mg once daily. Maintenance: 50-100mg once daily. Max: 100mg/day",
                common_side_effects=["Dizziness", "Upper respiratory infection", "Back pain", "Fatigue"],
                serious_side_effects=["Hyperkalemia", "Acute kidney injury", "Angioedema (rare)"],
                contraindications=["Pregnancy", "Use with aliskiren in diabetics"],
                monitoring=["Blood pressure", "Kidney function", "Potassium"],
                warnings=["Alternative to ACE inhibitors if cough develops", "Does not cause dry cough"],
            ),
            Drug(
                id="valsartan",
                ...
                serious_side_effects=["Hyperkalemia", "Hypotension", "Renal impairment"],
                contraindications=["Pregnancy", "Use with sacubitril (outside of Entresto)"],
                monitoring=["Blood pressure", "Kidney function", "Potassium"],
            ),
            ...
            Drug(
                ...
                indications=["Hypertension", "Heart failure", "Angina", "Post-heart attack", "Rate control in AFib"],
                dosing="Immediate release: 25-100mg twice daily. Extended release (Toprol-XL): 25-200mg once daily",
                common_side_effects=["Fatigue", "Dizziness", "Slow heart rate", "Cold hands/feet", "Depression"],
                serious_side_effects=["Severe bradycardia", "Heart block", "Worsening heart failure initially"],
                contraindications=["Severe bradycardia", "Heart block (without pacemaker)", "Cardiogenic shock", "Uncompensated heart failure"],
                monitoring=["Heart rate", "Blood pressure", "Heart failure symptoms"],
                warnings=["Do not stop abruptly - may cause rebound tachycardia", "May mask hypoglycemia symptoms in diabetics"],
            ),
            Drug(
                id="carvedilol",
                ...
                drug_class=DrugClass.BETA_BLOCKER,
                indications=["Heart failure", "Post-heart attack with LV dysfunction", "Hypertension"],
                dosing="Heart failure: Start 3.125mg twice daily, titrate to 25mg twice daily. Take with food.",
                common_side_effects=["Dizziness", "Fatigue", "Diarrhea", "Weight gain", "Hyperglycemia"],
                serious_side_effects=["Severe bradycardia", "Hypotension", "Worsening heart failure"],
                ...
                food_interactions=["Take with food to slow absorption and reduce orthostatic hypotension"],
            ...
            Drug(
                ...
                common_side_effects=["Ankle swelling (edema)", "Flushing", "Headache", "Dizziness", "Fatigue"],
                serious_side_effects=["Severe hypotension", "Worsening angina (rarely)"],
                contraindications=["Cardiogenic shock", "Severe aortic stenosis"],
                monitoring=["Blood pressure", "Ankle swelling"],
                warnings=["Ankle swelling is not fluid overload - different mechanism than heart failure edema"],
            ),
            Drug(
                id="diltiazem",
                ...
                common_side_effects=["Headache", "Dizziness", "Edema", "Bradycardia", "Constipation"],
                serious_side_effects=["Severe bradycardia", "Heart block", "Heart failure exacerbation"],
                contraindications=["Severe bradycardia", "Heart block", "Sick sinus syndrome", "Systolic heart failure"],
                monitoring=["Heart rate", "Blood pressure", "ECG if on digoxin"],
                warnings=["Do not use with beta-blockers without careful monitoring - risk of severe bradycardia"],
            ),
            ...
            Drug(
                ...
                common_side_effects=["Frequent urination", "Dehydration", "Dizziness", "Muscle cramps"],
                serious_side_effects=["Severe electrolyte imbalance (low potassium, sodium)", "Kidney injury", "Hearing loss (high IV doses)"],
                contraindications=["Anuria", "Severe electrolyte depletion"],
                monitoring=["Weight daily", "Kidney function", "Electrolytes (especially potassium)", "Blood pressure"],
                food_interactions=["Take in morning to avoid nighttime urination"],
                warnings=["Monitor potassium - may need supplements", "Weigh yourself daily - 2-3 lb gain may need dose adjustment"],
            ),
            Drug(
                ...
                common_side_effects=["Frequent urination", "Dizziness", "Increased blood sugar", "Increased uric acid"],
                serious_side_effects=["Electrolyte imbalance", "Kidney injury", "Photosensitivity"],
                contraindications=["Anuria", "Severe kidney disease", "Sulfa allergy (cross-reactivity possible)"],
                monitoring=["Blood pressure", "Electrolytes", "Kidney function", "Blood glucose"],
                warnings=["May increase blood sugar in diabetics", "Use sun protection - photosensitivity"],
            ),
            Drug(
                id="spironolactone",
                ...
                drug_class=DrugClass.DIURETIC,
                indications=["Heart failure (HFrEF)", "Resistant hypertension", "Ascites", "Primary aldosteronism"],
                dosing="Heart failure: 12.5-50mg once daily. Hypertension: 25-100mg once daily",
                common_side_effects=["Gynecomastia (breast enlargement in men)", "Breast tenderness", "Irregular periods", "Hyperkalemia"],
                serious_side_effects=["Severe hyperkalemia", "Kidney injury"],
                contraindications=["Severe kidney disease", "Hyperkalemia", "Addison's disease"],
                monitoring=["Potassium (closely!)", "Kidney function", "Blood pressure"],
                warnings=["Potassium-sparing - DO NOT use with potassium supplements or salt substitutes"],
            ),
            ...
            Drug(
                ...
                indications=["AFib stroke prevention", "DVT/PE treatment and prevention", "Post-hip/knee replacement"],
                ...
                serious_side_effects=["Major bleeding", "Intracranial hemorrhage", "GI bleeding"],
                ...
                warnings=["No routine monitoring needed (unlike warfarin)", "Reversal agent available (Andexxa)"],
            ),
            Drug(
                id="rivaroxaban",
                ...
                brand_names=["Xarelto"],
                drug_class=DrugClass.ANTICOAGULANT,
                indications=["AFib stroke prevention", "DVT/PE", "Post-hip/knee replacement", "CAD/PAD"],
                dosing="AFib: 20mg once daily with evening meal (or 15mg if CrCl 15-50)",
                common_side_effects=["Bleeding", "Back pain", "Dizziness"],
                serious_side_effects=["Major bleeding", "Spinal hematoma (with spinal procedures)"],
                contraindications=["Active bleeding", "Severe liver disease", "Mechanical heart valve"],
                monitoring=["Signs of bleeding", "Kidney function"],
                food_interactions=["MUST take with food (evening meal) for proper absorption"],
                warnings=["Take with largest meal of the day", "Do not stop without consulting doctor"],
            ),
            Drug(
                id="warfarin",
                ...
                drug_class=DrugClass.ANTICOAGULANT,
                indications=["AFib", "Mechanical heart valves", "DVT/PE", "Hypercoagulable states"],
                ...
                serious_side_effects=["Major bleeding", "Warfarin-induced skin necrosis", "Purple toe syndrome"],
                ...
                food_interactions=["Vitamin K foods (leafy greens) affect effect - keep intake consistent", 
                                  "Many drug interactions - check with pharmacist"],
                warnings=["Many drug and food interactions", "Reversal with Vitamin K or FFP if bleeding"],
            ),
            ...
            Drug(
                ...
                indications=["Secondary prevention after heart attack/stroke", "Post-stent", "Stable CAD"],
                dosing="Low-dose: 81mg once daily. Can use 325mg acutely",
                common_side_effects=["GI upset", "Heartburn", "Increased bleeding time"],
                serious_side_effects=["GI bleeding", "Hemorrhagic stroke", "Allergic reactions"],
                contraindications=["Active bleeding", "Aspirin allergy", "Severe asthma (aspirin-sensitive)"],
                monitoring=["Signs of bleeding", "GI symptoms"],
                warnings=["Do not use for primary prevention in most people (risk > benefit)", 
            ...
            Drug(
                ...
                brand_names=["Plavix"],
                drug_class=DrugClass.ANTIPLATELET,
                indications=["ACS", "Recent MI/stroke", "Peripheral artery disease", "Post-stent (with aspirin)"],
                ...
                warnings=["Do not stop before recommended duration after stent - stent thrombosis risk",
            ...
            Drug(
                ...
                indications=["High cholesterol", "Cardiovascular disease prevention", "Post-heart attack"],
                dosing="10-80mg once daily. High-intensity: 40-80mg. Moderate: 10-20mg",
                common_side_effects=["Muscle aches", "Headache", "GI upset", "Elevated liver enzymes"],
                serious_side_effects=["Rhabdomyolysis (rare)", "Liver damage", "New-onset diabetes"],
                contraindications=["Active liver disease", "Pregnancy", "Breastfeeding"],
                monitoring=["Lipid panel", "Liver function (baseline)", "Muscle symptoms"],
                food_interactions=["Grapefruit juice can increase drug levels"],
                warnings=["Report unexplained muscle pain, tenderness, or weakness immediately"],
            ),
            Drug(
                id="rosuvastatin",
                ...
                brand_names=["Crestor"],
                drug_class=DrugClass.STATIN,
                indications=["High cholesterol", "Cardiovascular prevention", "Slowing atherosclerosis"],
                dosing="5-40mg once daily. High-intensity: 20-40mg. Asian patients start 5mg",
                common_side_effects=["Muscle pain", "Headache", "Abdominal pain", "Nausea"],
                serious_side_effects=["Rhabdomyolysis", "Liver dysfunction", "Kidney effects"],
                contraindications=["Active liver disease", "Pregnancy", "Severe kidney disease (40mg)"],
            ...
            Drug(
                ...
                indications=["Acute angina", "Angina prevention", "Acute heart failure"],
                dosing="Sublingual: 0.3-0.6mg under tongue, may repeat x2 every 5 min. Patch: 0.2-0.8mg/hr",
                common_side_effects=["Headache", "Flushing", "Dizziness", "Low blood pressure"],
                serious_side_effects=["Severe hypotension", "Syncope", "Reflex tachycardia"],
                contraindications=["Use of PDE5 inhibitors (Viagra, Cialis)", "Severe anemia", "Increased ICP"],
                monitoring=["Blood pressure", "Heart rate", "Chest pain relief"],
                warnings=["NEVER use with Viagra/Cialis - severe hypotension", 
            ...
            Drug(
                ...
                indications=["Heart failure (all types)", "Type 2 diabetes", "Chronic kidney disease"],
                dosing="10-25mg once daily",
                common_side_effects=["Urinary tract infections", "Genital yeast infections", "Increased urination", "Thirst"],
                serious_side_effects=["Ketoacidosis (even with normal blood sugar)", "Fournier's gangrene (rare)", "Volume depletion"],
                contraindications=["Type 1 diabetes", "Dialysis"],
                monitoring=["Blood glucose", "Kidney function", "Volume status", "Signs of ketoacidosis"],
                warnings=["Hold before major surgery", "Check ketones if ill", "Benefits beyond glucose lowering in heart failure"],
            ),
            Drug(
                id="dapagliflozin",
                ...
                common_side_effects=["Genital infections", "UTIs", "Increased urination", "Back pain"],
                serious_side_effects=["Ketoacidosis", "Volume depletion", "Hypotension"],
                contraindications=["Type 1 diabetes", "Severe kidney disease", "Dialysis"],
                monitoring=["Blood glucose", "Kidney function", "Blood pressure", "Volume status"],
                warnings=["Proven benefits in heart failure regardless of diabetes status"],
            ),
            ...
            Drug(
                ...
                indications=["Life-threatening ventricular arrhythmias", "AFib rhythm control", "AFib cardioversion"],
                dosing="Loading: 800-1600mg/day for 1-3 weeks. Maintenance: 100-400mg daily",
                common_side_effects=["GI upset", "Photosensitivity", "Fatigue", "Tremor", "Bradycardia"],
                serious_side_effects=["Pulmonary toxicity", "Liver toxicity", "Thyroid dysfunction", "QT prolongation", "Vision changes"],
                contraindications=["Severe sinus node dysfunction", "2nd/3rd degree heart block", "Cardiogenic shock"],
                monitoring=["Thyroid function", "Liver function", "Pulmonary function", "ECG (QT interval)", "Eye exam"],
                food_interactions=["Grapefruit increases levels"],
                warnings=["Many drug interactions", "Long half-life (40-55 days)", "Use sun protection", "Regular monitoring essential"],
            ),
        ]
    ...
    def check_interactions(self, drug_names: List[str]) -> List[DrugInteraction]:
        ...
        for interaction in self._interactions:
            ...
            for name in normalized_names:
                if interaction.drug1.lower() in name.lower() or name.lower() in interaction.drug1.lower():
                    drug1_match = True
                    break
            ...
            for name in normalized_names:
                if interaction.drug2.lower() in name.lower() or name.lower() in interaction.drug2.lower():
                    drug2_match = True
                    break
            for cls in drug_classes:
...
if __name__ == "__main__":
    ...
    for interaction in interactions:
        print(f"  [{interaction.severity.value.upper()}] {interaction.drug1} + {interaction.drug2}")
