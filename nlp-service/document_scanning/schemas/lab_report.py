...
class LabReportSchema(BaseModel):
    ...
    lab_accreditation: Optional[str] = Field(None, description="Lab accreditation (e.g., NABL)")
    ...
    # Sample Information
    sample_type: Optional[str] = Field(None, description="Sample type (blood, urine, etc.)")
    sample_collected_date: Optional[date] = Field(None, description="Sample collection date")
    sample_collected_time: Optional[str] = Field(None, description="Sample collection time")
    sample_received_date: Optional[date] = Field(None, description="Sample received date")
    fasting: Optional[bool] = Field(None, description="Whether patient was fasting")
    
    # Test Results
    test_category: Optional[str] = Field(None, description="Category (CBC, Lipid Panel, etc.)")
    ...
    # Interpretation
    interpretation: Optional[str] = Field(None, description="Overall interpretation/comments")
    critical_values: Optional[List[str]] = Field(None, description="Any critical values detected")
...
LAB_TEST_CATEGORIES = {
    ...
    "liver_function": ["ast", "alt", "bilirubin", "albumin", "alkaline phosphatase", "ggt"],
