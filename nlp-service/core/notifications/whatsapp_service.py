...
class WhatsAppService:
    ...
    def send(
        ...
        try:
            ...
            params = {"from_": from_formatted, "to": to_formatted, "body": message}
    ...
    async def send_async(
        ...
        result = await loop.run_in_executor(
            None, lambda: self.send(to_number, message, media_url)
        )
    ...
    def send_template(
        ...
        try:
            ...
            if parameters:
                content_variables = {
                    str(i + 1): v for i, v in enumerate(parameters.values())
                }
...
class WhatsAppHealthSummaryService:
    ...
    def send_weekly_summary(
        self, phone_number: str, summary_message: str
    ) -> WhatsAppMessage:
        """
    ...
    def send_medication_reminder(
        self, phone_number: str, medication_name: str, time_str: str
    ) -> WhatsAppMessage:
        """
