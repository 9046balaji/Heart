...
class EventBus:
    ...
    def _topic_matches(pattern: str, topic: str) -> bool:
        ...
        regex_pattern = pattern.replace(".", r"\.").replace("**", ".*").replace("*", r"[^:]*")
...
async def publish_medication_reminder(user_id: str, medication_name: str, scheduled_time: str):
...
async def publish_health_alert(user_id: str, alert_type: str, message: str, severity: str = "warning"):
