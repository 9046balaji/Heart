...
class DatadogShipper(LogShipper):
    ...
    def __init__(self):
        ...
        try:
            ...
            raise ImportError("httpx required for Datadog integration. Install with: pip install httpx")
    ...
    async def ship(self, log_entry: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            if response.status_code == 202:
                ...
                logger.error(f"Failed to ship log to Datadog: {response.status_code} - {response.text}")
                return False
...
class SplunkShipper(LogShipper):
    ...
    def __init__(self):
        ...
        try:
            ...
            raise ImportError("httpx required for Splunk integration. Install with: pip install httpx")
    ...
    async def ship(self, log_entry: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            splunk_entry = {
                "time": datetime.fromisoformat(log_entry.get("timestamp", datetime.utcnow().isoformat())).timestamp(),
            ...
            if response.status_code in [200, 201]:
                ...
                logger.error(f"Failed to ship log to Splunk: {response.status_code} - {response.text}")
                return False
...
class CloudWatchShipper(LogShipper):
    ...
    def __init__(self):
        ...
        try:
            ...
            raise ImportError("boto3 required for AWS CloudWatch. Install with: pip install boto3")
        except Exception as e:
    ...
    async def ship(self, log_entry: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            cw_entry = {
                'timestamp': int(datetime.fromisoformat(log_entry.get("timestamp", datetime.utcnow().isoformat())).timestamp() * 1000),
