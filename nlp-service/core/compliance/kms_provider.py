...
class AzureKeyVaultProvider(KMSProvider):
    ...
    def __init__(self):
        ...
        try:
            ...
            raise ImportError(
                "azure-identity and azure-keyvault-keys required for Azure Key Vault. Install with: pip install azure-identity azure-keyvault-keys"
            )
        except Exception as e:
...
def get_kms_provider() -> KMSProvider:
    ...
    logger.warning(
        "Using environment variable fallback for KMS - NOT RECOMMENDED FOR PRODUCTION"
    )
