...
class ChromaDBService:
    ...
    async def seed_initial_knowledge(self):
        ...
        initial_data = [
            ...
            {
                "collection": "heart_health_general",
                "content": "Regular exercise is essential for heart health. The American Heart Association recommends "
                          "at least 150 minutes of moderate aerobic activity or 75 minutes of vigorous activity per week. "
                          "Exercise helps lower blood pressure, improve cholesterol, and maintain healthy weight.",
                "metadata": {"topic": "exercise", "source": "AHA"}
            },
            {
                "collection": "heart_health_general",
                "content": "A heart-healthy diet includes fruits, vegetables, whole grains, lean proteins, and healthy fats. "
                          "Limit sodium to less than 2,300mg per day (ideally 1,500mg for hypertension). "
                          "Avoid trans fats and limit saturated fats. The Mediterranean diet is recommended for cardiovascular health.",
                "metadata": {"topic": "diet", "source": "AHA"}
            }
        ]
