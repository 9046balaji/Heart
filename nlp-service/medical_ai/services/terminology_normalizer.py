...
class MedicalTerminologyNormalizer:
    ...
    ABBREVIATIONS: Dict[str, TermMapping] = {
        # Vitals
        "BP": TermMapping(
            "BP", "Blood Pressure", "Force of blood against your artery walls", "vital"
        ),
        "HR": TermMapping(
            "HR", "Heart Rate", "Number of heartbeats per minute", "vital"
        ),
        "RR": TermMapping(
            "RR", "Respiratory Rate", "Number of breaths per minute", "vital"
        ),
        "SpO2": TermMapping(
            "SpO2", "Oxygen Saturation", "Amount of oxygen in your blood", "vital"
        ),
        ...
        # Lab - Blood Count
        "CBC": TermMapping(
            "CBC", "Complete Blood Count", "Test that measures blood cells", "lab"
        ),
        "RBC": TermMapping("RBC", "Red Blood Cells", "Cells that carry oxygen", "lab"),
        "WBC": TermMapping(
            "WBC", "White Blood Cells", "Cells that fight infection", "lab"
        ),
        "Hb": TermMapping(
            "Hb", "Hemoglobin", "Protein in red blood cells that carries oxygen", "lab"
        ),
        "Hgb": TermMapping(
            "Hgb", "Hemoglobin", "Protein in red blood cells that carries oxygen", "lab"
        ),
        "HCT": TermMapping(
            "HCT", "Hematocrit", "Percentage of red blood cells in blood", "lab"
        ),
        "PLT": TermMapping("PLT", "Platelets", "Cells that help blood clot", "lab"),
        "MCV": TermMapping(
            "MCV", "Mean Corpuscular Volume", "Average size of red blood cells", "lab"
        ),
        "MCH": TermMapping(
            "MCH",
        ...
        "BMP": TermMapping(
            ...
            "Test for kidney function and electrolytes",
            "lab",
        ),
        "CMP": TermMapping(
            "CMP", "Comprehensive Metabolic Panel", "Extended chemistry test", "lab"
        ),
        "BUN": TermMapping(
            "BUN", "Blood Urea Nitrogen", "Waste product filtered by kidneys", "lab"
        ),
        "Cr": TermMapping(
            "Cr", "Creatinine", "Waste product from muscle activity", "lab"
        ),
        "GFR": TermMapping(
            "GFR", "Glomerular Filtration Rate", "How well kidneys filter blood", "lab"
        ),
        "eGFR": TermMapping(
            "eGFR",
        ...
        "K": TermMapping(
            "K", "Potassium", "Electrolyte for heart and muscle function", "lab"
        ),
        "Cl": TermMapping("Cl", "Chloride", "Electrolyte for fluid balance", "lab"),
        "CO2": TermMapping(
            "CO2", "Carbon Dioxide/Bicarbonate", "Measure of blood acidity", "lab"
        ),
        "Ca": TermMapping("Ca", "Calcium", "Mineral for bones and muscles", "lab"),
        "Mg": TermMapping(
            "Mg", "Magnesium", "Mineral for nerve and muscle function", "lab"
        ),
        # Lab - Liver
        "LFT": TermMapping(
            "LFT", "Liver Function Tests", "Tests for liver health", "lab"
        ),
        ...
        "SGOT": TermMapping(
            ...
            "Liver enzyme (same as AST)",
            "lab",
        ),
        "SGPT": TermMapping(
            "SGPT",
            "Serum Glutamic-Pyruvic Transaminase",
            "Liver enzyme (same as ALT)",
            "lab",
        ),
        "ALP": TermMapping(
            "ALP", "Alkaline Phosphatase", "Enzyme from liver and bones", "lab"
        ),
        ...
        "D.Bil": TermMapping(
            "D.Bil", "Direct Bilirubin", "Bilirubin processed by liver", "lab"
        ),
        "Alb": TermMapping("Alb", "Albumin", "Protein made by liver", "lab"),
        # Lab - Lipids
        "TC": TermMapping(
            "TC", "Total Cholesterol", "Total amount of cholesterol in blood", "lab"
        ),
        "TG": TermMapping("TG", "Triglycerides", "Type of fat in blood", "lab"),
        "HDL": TermMapping(
            "HDL", "High-Density Lipoprotein", "Good cholesterol", "lab"
        ),
        "LDL": TermMapping("LDL", "Low-Density Lipoprotein", "Bad cholesterol", "lab"),
        "VLDL": TermMapping(
            "VLDL", "Very Low-Density Lipoprotein", "Carries triglycerides", "lab"
        ),
        # Lab - Thyroid
        "TSH": TermMapping(
            "TSH", "Thyroid Stimulating Hormone", "Controls thyroid function", "lab"
        ),
        ...
        # Lab - Diabetes
        "FBS": TermMapping(
            "FBS", "Fasting Blood Sugar", "Blood sugar after overnight fast", "lab"
        ),
        "RBS": TermMapping(
            "RBS", "Random Blood Sugar", "Blood sugar at any time", "lab"
        ),
        "PPBS": TermMapping(
            "PPBS", "Post-Prandial Blood Sugar", "Blood sugar after eating", "lab"
        ),
        "HbA1c": TermMapping(
            "HbA1c", "Glycated Hemoglobin", "Average blood sugar over 3 months", "lab"
        ),
        "A1c": TermMapping(
            "A1c", "Hemoglobin A1c", "Average blood sugar over 3 months", "lab"
        ),
        "GTT": TermMapping("GTT", "Glucose Tolerance Test", "Test for diabetes", "lab"),
        "OGTT": TermMapping(
            "OGTT", "Oral Glucose Tolerance Test", "Diabetes screening test", "lab"
        ),
        # Lab - Cardiac
        "CK": TermMapping(
            "CK", "Creatine Kinase", "Enzyme from muscles and heart", "lab"
        ),
        "CK-MB": TermMapping(
            "CK-MB", "Creatine Kinase-MB", "Heart-specific enzyme", "lab"
        ),
        "LDH": TermMapping(
            "LDH", "Lactate Dehydrogenase", "Enzyme indicating tissue damage", "lab"
        ),
        "BNP": TermMapping(
            "BNP", "B-type Natriuretic Peptide", "Heart failure marker", "lab"
        ),
        "CRP": TermMapping("CRP", "C-Reactive Protein", "Inflammation marker", "lab"),
        "ESR": TermMapping(
            "ESR", "Erythrocyte Sedimentation Rate", "Inflammation marker", "lab"
        ),
        # Lab - Urine
        "UA": TermMapping("UA", "Urinalysis", "Urine test", "lab"),
        "UTI": TermMapping(
            "UTI", "Urinary Tract Infection", "Infection in urinary system", "lab"
        ),
        ...
        "TID": TermMapping(
            "TID", "Three Times Daily", "Take three times a day", "medication"
        ),
        "QID": TermMapping(
            "QID", "Four Times Daily", "Take four times a day", "medication"
        ),
        "HS": TermMapping(
            "HS", "At Bedtime", "Take at night before sleeping", "medication"
        ),
        ...
        "Inj": TermMapping(
            "Inj", "Injection", "Medicine given by needle", "medication"
        ),
        ...
        "mcg": TermMapping(
            "mcg", "micrograms", "Unit of weight (1/1000 milligram)", "unit"
        ),
        "mL": TermMapping("mL", "milliliters", "Unit of volume (1/1000 liter)", "unit"),
        "IU": TermMapping(
            "IU",
            "International Units",
            "Standardized unit for vitamins/medicines",
            "unit",
        ),
        "bpm": TermMapping("bpm", "beats per minute", "Heart rate measurement", "unit"),
        "mmHg": TermMapping(
            "mmHg", "millimeters of mercury", "Blood pressure unit", "unit"
        ),
        "g/dL": TermMapping(
            "g/dL", "grams per deciliter", "Concentration unit", "unit"
        ),
        "mg/dL": TermMapping(
            "mg/dL", "milligrams per deciliter", "Concentration unit", "unit"
        ),
        "mmol/L": TermMapping(
            "mmol/L", "millimoles per liter", "Concentration unit", "unit"
        ),
        # Common Diagnoses
        ...
        "CAD": TermMapping(
            "CAD", "Coronary Artery Disease", "Heart artery blockage", "diagnosis"
        ),
        "CHF": TermMapping(
            "CHF", "Congestive Heart Failure", "Heart not pumping well", "diagnosis"
        ),
        "COPD": TermMapping(
            "COPD",
            "Chronic Obstructive Pulmonary Disease",
            "Lung disease causing breathing difficulty",
            "diagnosis",
        ),
        "CKD": TermMapping(
            "CKD", "Chronic Kidney Disease", "Long-term kidney damage", "diagnosis"
        ),
        ...
        "AF": TermMapping(
            "AF", "Atrial Fibrillation", "Irregular heartbeat", "diagnosis"
        ),
        "GERD": TermMapping(
            "GERD", "Gastroesophageal Reflux Disease", "Acid reflux", "diagnosis"
        ),
        # Procedures
        "ECG": TermMapping(
            "ECG", "Electrocardiogram", "Heart electrical activity test", "procedure"
        ),
        "EKG": TermMapping(
            "EKG", "Electrocardiogram", "Heart electrical activity test", "procedure"
        ),
        "ECHO": TermMapping("ECHO", "Echocardiogram", "Heart ultrasound", "procedure"),
        "CT": TermMapping(
            "CT", "Computed Tomography", "Detailed X-ray scan", "procedure"
        ),
        "MRI": TermMapping(
            "MRI",
            "Magnetic Resonance Imaging",
            "Detailed body scan using magnets",
            "procedure",
        ),
    ...
    def __init__(self):
        ...
        for abbr, mapping in self.ABBREVIATIONS.items():
            ...
            pattern = re.compile(rf"\b{re.escape(abbr)}\b(?:\s*:)?", re.IGNORECASE)
            ...
            if pattern.search(normalized):
                ...
                if add_explanations:
                    if explanation_format == "parentheses":
                        replacement = (
                            f"{mapping.full_term} ({mapping.plain_explanation})"
                        )
    ...
    def add_custom_term(self, mapping: TermMapping) -> None:
        ...
        pattern = re.compile(
            rf"\b{re.escape(mapping.abbreviation)}\b(?:\s*:)?", re.IGNORECASE
        )
    ...
    def get_terms_by_category(self, category: str) -> List[TermMapping]:
        ...
        return [
            mapping
            for mapping in self.ABBREVIATIONS.values()
