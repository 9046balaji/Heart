...
class TesseractOCREngine(BaseOCREngine):
    ...
    def extract_text(self, file_path: str) -> OCRResult:
        ...
        try:
            ...
            avg_confidence = (total_confidence / block_count / 100) if block_count else 0
        ...
        try:
            ...
            for key_id, key_block in key_map.items():
                ...
                if value_block_id and value_block_id in value_map:
                    value_text = self._get_text_from_block(value_map[value_block_id], block_map)
...
class OCREngineFactory:
    ...
    def get_available_providers(self) -> List[OCRProvider]:
        ...
        return [
            provider for provider, engine in self.engines.items()
