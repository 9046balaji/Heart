...
class MedicalDocumentClassifier:
    ...
    def __init__(self):
        ...
        self.section_patterns = {
            "patient_info": re.compile(r'\b(patient\s*(name|info|details)|name\s*:|age\s*:|gender\s*:)', re.I),
            "test_results": re.compile(r'\b(test\s*results?|lab\s*values?|parameters?)', re.I),
            ...
            "recommendations": re.compile(r'\b(recommendations?|advice|plan|follow[\s-]?up)', re.I),
            "doctor_info": re.compile(r'\b(doctor|physician|dr\.|consultant|referred)', re.I),
            "billing": re.compile(r'\b(charges?|fees?|total|amount|payment)', re.I),
            "instructions": re.compile(r'\b(instructions?|advice|precautions?|warnings?)', re.I),
        }
    ...
    def classify(self, text: str) -> ClassificationResult:
        ...
        logger.info(f"Classified document as {best_category.value} with confidence {confidence:.2%}")
