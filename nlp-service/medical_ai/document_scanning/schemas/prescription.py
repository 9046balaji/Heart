...
class Medication(BaseModel):
    ...
    frequency_code: Optional[FrequencyCode] = Field(None, description="Standard frequency code")
    times_per_day: Optional[int] = Field(None, ge=1, le=24, description="Number of times per day")
    
    # Timing
    timing: Optional[str] = Field(None, description="When to take (before meals, etc.)")
    specific_times: Optional[List[str]] = Field(None, description="Specific times (8am, 2pm, etc.)")
    
    # Duration
    duration_value: Optional[int] = Field(None, description="Duration number")
    duration_unit: Optional[str] = Field(None, description="Duration unit (days, weeks, months)")
    ...
    # Instructions
    route: Optional[str] = Field(None, description="Route of administration (oral, topical, etc.)")
...
class PrescriptionSchema(BaseModel):
    ...
    doctor_qualification: Optional[str] = Field(None, description="Doctor qualifications")
    doctor_registration_no: Optional[str] = Field(None, description="Medical registration number")
    ...
    general_instructions: Optional[str] = Field(None, description="General instructions")
    ...
    # Emergency
    emergency_instructions: Optional[str] = Field(None, description="Emergency instructions")
    ...
    is_handwritten: bool = Field(default=False, description="Whether prescription is handwritten")
