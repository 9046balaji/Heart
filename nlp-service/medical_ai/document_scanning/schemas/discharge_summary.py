...
class DischargeSummarySchema(BaseModel):
    ...
    admission_type: Optional[AdmissionType] = Field(None, description="Type of admission")
    ...
    discharge_status: Optional[DischargeStatus] = Field(None, description="Discharge status")
    length_of_stay: Optional[int] = Field(None, ge=0, description="Length of stay in days")
    
    # Medical Team
    attending_doctor: Optional[str] = Field(None, description="Attending physician")
    consulting_doctors: Optional[List[str]] = Field(None, description="Consulting doctors")
    resident_doctor: Optional[str] = Field(None, description="Resident doctor")
    
    # Diagnosis
    chief_complaint: Optional[str] = Field(None, description="Chief complaint at admission")
    primary_diagnosis: Optional[str] = Field(None, description="Primary/Principal diagnosis")
    ...
    vitals_at_admission: Optional[VitalSignsRecord] = Field(None, description="Vitals at admission")
    vitals_at_discharge: Optional[VitalSignsRecord] = Field(None, description="Vitals at discharge")
    
    # Investigations
    investigations_summary: Optional[str] = Field(None, description="Summary of investigations")
    ...
    # Hospital Course
    hospital_course: Optional[str] = Field(None, description="Course during hospital stay")
    treatment_given: Optional[str] = Field(None, description="Treatment given during stay")
    
    # Procedures
    procedures: List[ProcedureRecord] = Field(default_factory=list, description="Procedures performed")
    ...
    dietary_instructions: Optional[str] = Field(None, description="Dietary instructions")
    activity_restrictions: Optional[str] = Field(None, description="Activity restrictions")
    ...
    emergency_instructions: Optional[str] = Field(None, description="When to seek emergency care")
    ...
    condition_at_discharge: Optional[str] = Field(None, description="Condition at discharge")
