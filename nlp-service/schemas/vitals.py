...
class VitalsReading(BaseModel):
    ...
    blood_pressure_systolic: Optional[int] = Field(None, ge=60, le=250, description="Systolic blood pressure in mmHg")
    blood_pressure_diastolic: Optional[int] = Field(None, ge=40, le=150, description="Diastolic blood pressure in mmHg")
    blood_oxygen: Optional[float] = Field(None, ge=70.0, le=100.0, description="Blood oxygen saturation percentage")
    temperature: Optional[float] = Field(None, ge=90.0, le=110.0, description="Body temperature in Fahrenheit")
