...
class ContextRetriever:
    ...
    def _analyze_query_needs(self, query: str) -> List[ContextType]:
        ...
        if not needs:
            needs = [ContextType.RECENT_VITALS, ContextType.USER_PREFERENCES]
    ...
    async def _retrieve_single_type(
        self, user_id: str, session_id: str, query: str, context_type: ContextType
    ) -> List[RetrievedContext]:
    ...
    async def _get_recent_vitals(
        ...
        if not self.vitals:
            ...
            return [
                RetrievedContext(
                    ...
                    data={"message": "No vitals service connected", "available": False},
                    relevance_score=0.3,
        ...
        try:
            ...
            vitals = await self.vitals.get_recent_vitals(user_id=user_id, since=cutoff)
    ...
    async def _get_last_consultation(self, user_id: str) -> List[RetrievedContext]:
    ...
    async def _get_medications(self, user_id: str) -> List[RetrievedContext]:
    ...
    async def _get_user_preferences(self, user_id: str) -> List[RetrievedContext]:
        ...
        try:
            prefs = self.preferences.get_all_preferences(
                user_id=user_id, include_sensitive=False
            )
    ...
    async def _get_risk_assessments(self, user_id: str) -> List[RetrievedContext]:
    ...
    async def _get_medical_history(self, user_id: str) -> List[RetrievedContext]:
    ...
    async def _get_lifestyle_data(self, user_id: str) -> List[RetrievedContext]:
    ...
    async def _get_emergency_info(self, user_id: str) -> List[RetrievedContext]:
    ...
    def _make_cache_key(self, user_id: str, session_id: str, query: str) -> str:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "cache_hit_rate": (self._cache_hits / max(1, self._retrieval_count) * 100),
