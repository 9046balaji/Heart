...
class CardioSpecialistAgent:
    ...
    # Cardiac medications
    CARDIAC_MEDICATIONS = [
        "aspirin", "metoprolol", "lisinopril", "amlodipine",
        "atorvastatin", "warfarin", "clopidogrel", "digoxin",
        "furosemide", "carvedilol", "losartan", "nitroglycerin",
    ]
    ...
    def _analyze_history(self, medical_history: Dict) -> Dict[str, Any]:
        ...
        cardiac_conditions = [
            ...
            "previous_heart_attack", "stroke", "peripheral_artery_disease",
        ]
