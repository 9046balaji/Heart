    ...
    async def disconnect(self, session_id: str):
        ...
        async with self._lock:
            if session_id in self._connections:
                ...
                logger.info(f"WebSocket disconnected: user={user_id}, session={session_id}, duration={connection.connection_duration:.1f}s")
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                await manager.send_to_session(session_id, WebSocketMessage(
                    type=MessageType.ERROR,
            ...
            if msg_type == MessageType.PING:
                ...
                await manager.send_to_session(session_id, WebSocketMessage(
                    type=MessageType.ERROR,
                    data={"error": f"Unknown message type: {msg_type}", "code": "UNKNOWN_TYPE"}
                ))
