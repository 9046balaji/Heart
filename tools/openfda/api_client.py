...
class OpenFDAClient:
    ...
    def _make_request(self, endpoint: str, params: Dict[str, Any]) -> FDAResult:
        """
    ...
    def search_drug_enforcement(self, query: str, limit: int = 10, sort: str = None) -> FDAResult:
        """Search drug recall/enforcement endpoint"""
        params = {"search": query, "limit": limit}
        if sort:
            params["sort"] = sort
        return self._make_request("/drug/enforcement.json", params)

    def search_drug_label(self, query: str, limit: int = 10) -> FDAResult:
        """Search drug product labeling endpoint"""
        params = {"search": query, "limit": limit}
        return self._make_request("/drug/label.json", params)
        
    def search_food_enforcement(self, query: str, limit: int = 10, sort: str = None) -> FDAResult:
        """Search food recall/enforcement endpoint"""
        params = {"search": query, "limit": limit}
        if sort:
            params["sort"] = sort
        return self._make_request("/food/enforcement.json", params)

    def search_drug_events(self, query: str, limit: int = 5) -> FDAResult:
        """Search drug adverse events (FAERS)"""
        params = {"search": query, "limit": limit}
        return self._make_request("/drug/event.json", params)

    def search_food_events(self, query: str, limit: int = 5) -> FDAResult:
        """Search food/supplement adverse events (CAERS)"""
        params = {"search": query, "limit": limit}
        return self._make_request("/food/event.json", params)
