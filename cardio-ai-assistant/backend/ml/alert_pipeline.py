...
from .chatbot_connector import ChatbotManager, ChatResponse
...
class AlertPipeline:
    ...
    async def process_prediction(
        ...
        alert = Alert(
            ...
            message=prediction.alert_message or f"Health anomaly detected: {anomaly_type}",
    ...
    def _determine_channels(self, severity: str) -> List[AlertChannel]:
        ...
        channel_map = {
            ...
            "CRITICAL": [AlertChannel.IN_APP, AlertChannel.PUSH_NOTIFICATION, AlertChannel.WEBSOCKET],
            "EMERGENCY": [AlertChannel.IN_APP, AlertChannel.PUSH_NOTIFICATION, AlertChannel.WEBSOCKET, AlertChannel.SMS],
        }
    ...
    def _generate_title(self, anomaly_type: str, severity: str) -> str:
        ...
        name = type_names.get(anomaly_type.lower(), anomaly_type.replace("_", " ").title())
        ...
        if self.chatbot.is_available():
            try:
                ...
                context = PromptContext(
                    ...
                    is_resting=True,
                    tone=ResponseTone.URGENT if severity in ["CRITICAL", "EMERGENCY"] else ResponseTone.CONCERNED
                )
