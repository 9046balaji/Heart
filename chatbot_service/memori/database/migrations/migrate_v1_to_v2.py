...
class MigrationHelper:
    ...
    def _detect_db_type(self, url: str) -> str:
        ...
        if url.startswith("postgresql"):
            ...
            raise ValueError(f"Unsupported database type in URL: {url}. Only PostgreSQL is supported.")
    ...
    def _ensure_database_exists(self):
        """Ensure the target database exists (PostgreSQL only)"""
        ...
        try:
            ...
            if "does not exist" in str(e):
                ...
                try:
                    ...
                    # For PostgreSQL, we need to set isolation_level="AUTOCOMMIT" to run CREATE DATABASE
